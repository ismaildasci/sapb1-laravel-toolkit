# Actions, DTOs and Builders for SAP Business One Service Layer
...
```php
$toolkit = new SapB1\Toolkit();
echo $toolkit->echoPhrase('Hello, SapB1!');
```
...
- [İsmail Daşcı](https://github.com/ismaildasci)
