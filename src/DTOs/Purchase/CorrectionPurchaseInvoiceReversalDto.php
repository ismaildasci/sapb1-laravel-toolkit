...
/**
 * Correction Purchase Invoice Reversal DTO.
 *
 * @phpstan-consistent-constructor
 */
final class CorrectionPurchaseInvoiceReversalDto extends DocumentDto
{
    public function __construct(
        ...
        public readonly ?int $originalCorrectionEntry = null,
    ) {
        parent::__construct(
            docEntry: $docEntry,
            docNum: $docNum,
    ...
    protected static function mapFromArray(array $data): array
    {
        return array_merge(parent::mapFromArray($data), [
            ...
            'originalCorrectionEntry' => $data['OriginalCorrectionEntry'] ?? null,
        ]);
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->originalCorrectionEntry !== null) {
            $data['OriginalCorrectionEntry'] = $this->originalCorrectionEntry;
        }
