 ...
 */
final class DraftDto extends DocumentDto
{
    public function __construct(
        ...
        ?string $project = null,
        array $documentLines = [],
        public readonly ?DocumentType $docObjectCode = null,
    ) {
        parent::__construct(
            docEntry: $docEntry,
            docNum: $docNum,
    ...
    protected static function mapFromArray(array $data): array
    {
        return array_merge(parent::mapFromArray($data), [
            'docObjectCode' => isset($data['DocObjectCode']) ? DocumentType::tryFrom((int) $data['DocObjectCode']) : null,
        ]);
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->docObjectCode !== null) {
            $data['DocObjectCode'] = $this->docObjectCode->value;
        }
