...
/**
 * Builder for Inventory General Entries (Goods Receipt).
 *
 * @phpstan-consistent-constructor
 */
final class InventoryGenEntryBuilder extends BaseBuilder
{
    ...
    /**
     * @param  array<InventoryGenEntryLineDto|array<string, mixed>>  $lines
     */
    public function documentLines(array $lines): static
    {
        $mapped = array_map(function ($line) {
            if ($line instanceof InventoryGenEntryLineDto) {
                return $line->toArray();
            }
    ...
    /**
     * @param  InventoryGenEntryLineDto|array<string, mixed>  $line
     */
    public function addLine(InventoryGenEntryLineDto|array $line): static
    {
        $lines = $this->get('DocumentLines', []);
        $lines[] = $line instanceof InventoryGenEntryLineDto ? $line->toArray() : $line;
