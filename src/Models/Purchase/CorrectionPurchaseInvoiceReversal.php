...
/**
 * Correction Purchase Invoice Reversal model.
 */
class CorrectionPurchaseInvoiceReversal extends SapB1Model
{
    protected static string $entity = 'CorrectionPurchaseInvoiceReversal';
